<template>
  <div>
    <div class="goods">
              ...
              <li @click="selectFood(food)" v-for="(food, index) in item.foods" :key="index" class="food-item border-1px">
                ...
                <div class="content">
                  ...
                  <div class="carcontrol-wrapper">
                    <carcontrol @caradd="_drop" :food="food"></carcontrol>
                  </div>
                </div>
              </li>
            </ul> 
      ...
      <shopcat ref="shopcar" :select-foods="selectFoods"  :delivery-price="seller.deliveryPrice" :min-price="seller.minPrice"></shopcat>
    </div>
    <food :food="selectedFood"  @caradd="_drop" ref="food"></food>
  </div>
</template>
